...
CreateButton("Mobile", UDim2.new(0, 20, 0.5, -30), mainFrame, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Sosiskomras/Dig-Deep/refs/heads/main/MobileMain.lua", true))()
end)

CreateButton("PC", UDim2.new(0, 185, 0.5, -30), mainFrame, function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Sosiskomras/Dig-Deep/refs/heads/main/Main.lua", true))()
end)
